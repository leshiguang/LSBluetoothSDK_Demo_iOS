...
/**
[""]    Description s第三方账号授权登录
[""]    @param tenantId 租户ID
[""]    @param subscriptionId 订阅ID
[""]    @param associatedId 第三方账号
[""]    @param complete 授权信息
[""] */
-(void) authorize:(NSInteger)tenantId andSubscribe:(NSInteger)subscriptionId andThirdUserId:(NSString *)associatedId callback:(void (^)(NSInteger userId, NSString *accessToken)) complete;
