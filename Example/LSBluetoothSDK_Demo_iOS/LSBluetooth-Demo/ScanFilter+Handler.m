                                   ...
                                   context:(NSManagedObjectContext *)context
{
    ...
    BOOL enableAllDevice=[[oldScanFilter valueForKeyPath:KEY_SCAN_FILTER_ALL_DEVICE] boolValue];
    ...
    oldScanFilter.enableAllDevice=[NSNumber numberWithBool:enableAllDevice];
                  ...
                  inManagedObjectContext:(NSManagedObjectContext *)context
{
    ...
    BOOL enableAllDevice=[[scanFilterInfo valueForKeyPath:KEY_SCAN_FILTER_ALL_DEVICE] boolValue];
    ...
    newScanFilter.enableAllDevice=[NSNumber numberWithBool:enableAllDevice];
