...
/// @param mac 设备mac地址
/// @param complete 回调
-(void) authorizeDevice:(NSString *)appId andService:(NSString *)serviceId andVersion:(NSString *)serviceVersion andMac:(NSString *)mac andModel:(NSString *)model  withBlock:(void (^)(NSInteger)) complete;
...
/// @param complete 回调
-(void) authorize:(NSString *)appId andService:(NSString *)serviceId andVersion:(NSString *)serviceVersion withBlock:(void (^)(NSInteger)) complete;
